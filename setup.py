...
#
#     from gdalrelief import metadata
#
# However, when we do this, we also import `gdalrelief/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'gdalrelief_cli = gdalrelief.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'gdalrelief_gui = gdalrelief.gui:entry_point'
        # ]
    }
)
